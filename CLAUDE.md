...
10. Always show the user the line numbers in `/home/jjcm/runbooks/huanca/FRAUD_LAB_COMPLETE_V9.md` that match the proposed changes before executing anything.
